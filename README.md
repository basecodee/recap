...
2. Setup environment variables:
   ...
   - Copy `backend/.env.example` to `backend/.env` dan sesuaikan database config
3. Install dependencies: `npm install`
4. Setup database:
   - Jalankan XAMPP/WAMP
   - Import database schema dari `supabase/migrations/`
5. Jalankan development server: `npm run dev`
6. Login dengan credentials: username `admin`, password `admin123`
...
- Auto-logout tersedia di navigation bar
